...
<html class="no-js" lang="">
    <head>
        ...
        <title>GirlDevelopIt Central VA Directory</title>
        <meta name="description" content="The people of GirlDevelopIt CentralVA">
    ...
    <body>
        ...
        <header>
        <h1>GDI CentralVA Directory</h1>
        <div class="header-links">
          <p><a href="https://github.com/${repo}">Add yourself</a></p>
          <p><a href="https://www.meetup.com/Girl-Develop-It-CentralVA">GDI CentralVA @ Meetup</a></p>
        </div>
        </header>
...
<%def name="render_entry(data)">
  <div class="entry">
    <h3 style="display: inline;"><strong>${data['name']}</strong></h3>
    <span class="links">
